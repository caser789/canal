// Package mysql const
// see mysql protocol for more details
// https://dev.mysql.com/doc/dev/mysql-server/latest/page_protocol_basic_packets.html#sect_protocol_basic_packets_packet
// 协议分析 http://hutaow.com/blog/2013/11/06/mysql-protocol-analysis/
package mysql

const (
	MinProtocolVersion byte = 10
	// MaxPayloadLen If a MySQL client or server wants to send data, it:
	//     1. Splits the data into packets of size 2^24 (1<<24) bytes
	//     2. Prepends to each chunk a packet header
...
const (
	OK_HEADER byte = 0x00
	// EOF_HEADER As of MySQL 5.7.5, OK packets are also used to indicate EOF, and EOF packets are deprecated.
	EOF_HEADER byte = 0xfe
	// ERR_HEADER https://dev.mysql.com/doc/dev/mysql-server/latest/page_protocol_basic_err_packet.html
